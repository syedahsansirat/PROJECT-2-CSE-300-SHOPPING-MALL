 ...
 * @author Sirat
 */
public class PreViewPayment extends javax.swing.JFrame {

    /**
     * Creates new form preViewEdit
     */
    public PreViewPayment() {
        initComponents();
        setVisible(true);
    ...
    private void initComponents() {
        ...
        EnterIdLabel.setText("Enter Rent ID :");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PreEditShop.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PreViewPayment().setVisible(true);
            }
        });
    }
