...
public class ViewPayment extends javax.swing.JFrame {
    ...
    void setDetails() {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT name FROM `rent`,`tenant` WHERE rent_id=" + id);
            while (resultSet.next()) {
                tenantName = resultSet.getString(1);
            }
            roomNoTextField.setText("Room No : " + roomNo);
            tenantNameTextField.setText("Tenant Name : " + tenantName);
            statement = con.createStatement();
    ...
    private void initComponents() {
        ...
        tenantNameTextField.setText("Tenant Name");
        tenantNameTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tenantNameTextFieldActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(tenantNameTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE)
    ...
    private void tenantNameTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tenantNameTextFieldActionPerformed

    }//GEN-LAST:event_tenantNameTextFieldActionPerformed
