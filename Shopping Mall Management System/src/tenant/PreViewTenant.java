 ...
 * @author Sirat
 */
public class PreViewTenant extends javax.swing.JFrame {

    /**
     * Creates new form preViewEdit
     */
    public PreViewTenant() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PreViewTenant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PreViewTenant().setVisible(true);
            }
        });
    }
