...
public class DealFinal extends javax.swing.JFrame {
    ...
    public DealFinal(String shopId, String tenantId) {
        initComponents();
        this.shopId = shopId;
    ...
    private void initComponents() {
        ...
        iconLabel.setBounds(-10, -30, 450, 360);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DealFinal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DealFinal("1", "1").setVisible(true);
            }
        });
    }
